...
class QCertApp:
    ...
    def _build_data_panel(self, parent):
        ...
        ctk.CTkEntry(sf, textvariable=self.goto_var, width=60, height=28,
        ...
        ctk.CTkEntry(sf2, textvariable=self.search_var, width=120, height=28,
                     fg_color=THEME["bg_card"], border_color=THEME["border"],
                     border_width=1, text_color=THEME["text_main"],
                     corner_radius=8).pack(side="left", padx=4)
    ...
    def _build_text_field_controls(self, parent):
        ...
        for label, key, default, widget_type in [
            ...
            if widget_type == "entry":
                ...
                ctk.CTkEntry(props, textvariable=var, width=100, height=22,
                             fg_color=THEME["bg_card"], border_color=THEME["border"],
                             border_width=1, text_color=THEME["text_main"],
                             corner_radius=8).grid(row=row, column=1, sticky="ew", padx=3, pady=1)
                ...
                ctk.CTkEntry(f, textvariable=var, width=70, height=22,
                             fg_color=THEME["bg_card"], border_color=THEME["border"],
                             border_width=1, text_color=THEME["text_main"],
    ...
    def _build_image_controls(self, parent):
        ...
        for label, key, default, wtype in [
            ...
            if wtype == "entry":
                var = tk.StringVar(value=str(default))
                ctk.CTkEntry(props, textvariable=var, width=120, height=26,
                             fg_color=THEME["bg_card"], border_color=THEME["border"],
                             border_width=1, text_color=THEME["text_main"],
                             corner_radius=8).grid(row=row, column=1, sticky="ew", padx=4, pady=2)
            elif wtype == "file":
                var = tk.StringVar(value=default)
                f = ctk.CTkFrame(props, fg_color="transparent")
                f.grid(row=row, column=1, sticky="ew", padx=4, pady=2)
                ctk.CTkEntry(f, textvariable=var, width=90, height=26,
                             fg_color=THEME["bg_card"], border_color=THEME["border"],
                             border_width=1, text_color=THEME["text_main"],
    ...
    def _build_output_controls(self, parent):
        ...
        ctk.CTkEntry(dir_frame, textvariable=self.outdir_var, height=28,
                     fg_color=THEME["bg_card"], border_color=THEME["border"],
                     border_width=1, text_color=THEME["text_main"],
                     corner_radius=8).pack(
            side="left", fill="x", expand=True)
        ...
        ctk.CTkEntry(f, textvariable=self.fname_var, height=28,
                     fg_color=THEME["bg_card"], border_color=THEME["border"],
                     border_width=1, text_color=THEME["text_main"],
                     corner_radius=8).pack(fill="x", pady=2)
...
class _RangeDialog(ctk.CTkToplevel):
    def __init__(self, parent, total):
        ...
        ctk.CTkEntry(self, textvariable=self.entry_var, width=260, height=30,
                     fg_color=THEME["bg_card"], border_color=THEME["border"],
                     border_width=1, text_color=THEME["text_main"],
                     corner_radius=8).pack(padx=16, pady=8)
